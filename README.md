...
Makefile. `signoff-final` bypasses the generic precheck KLayout adapter, whose
LibreLane-style variables do not configure the pinned raw GF180 deck, and runs
that deck with its native switches: variant D (11K/5LM/MIM-B), deep mode,
