...
# generated by this repository: FINAL_GDS_SOURCE is imported as-is and only
# the Wafer.Space GF180 seal ring is added.
...
final-gds: $(SIGNOFF_DIR)/pdk/.git ## Add only the GF180 seal ring to FINAL_GDS_SOURCE
